...
OI::OI() 
{
	...
	buttonHelper1 = new ButtonHelper(driverJoystick);
	buttonHelper2 = new ButtonHelper(shooterGamepad);
    ...
    buttonStartAutoLoad = new JoystickButton(shooterGamepad, 8); // Toggle AutoLoad
